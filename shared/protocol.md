...
- Max RTP payload: 1200 bytes (leaving room for RTP/UDP/IP headers + network overhead)
...
| Rate control         | CBR                      |
| Target bitrate       | 150 Mbps (1080p) / 250 Mbps (1440p) / 500 Mbps (4K) |
| Keyframe interval    | 1 (all-intra, every frame is an I-frame) |
